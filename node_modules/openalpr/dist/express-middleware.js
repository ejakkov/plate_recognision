(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('debug'), require('axios')) :
    typeof define === 'function' && define.amd ? define(['debug', 'axios'], factory) :
    (global = global || self, factory(global.debug, global.axios));
}(this, (function (Debug, axios) { 'use strict';
    ...
    module.exports = (fileIndex) => async (req, res, next) => {
      ...
      const handleRecognition = result => {
        ...
        debug$5('Success recognizing vehicle!');
      ...
      try {
        ...
        debug$5('Generating encoded base64 file');

        debug$5('Starting vehicle recognition');
        const result = await openALPR$1.recognize(encoded);

        debug$5('Starting to handle recognition...');
        handleRecognition(result);

        next();

      } catch(err) {
        debug$5('Vehicle recognition failed');
        next(err);
      }
